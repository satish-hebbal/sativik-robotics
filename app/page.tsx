              ...
              <div className="flex items-start lg:items-center gap-4 lg:gap-8">
                ...
                <div className="flex-1 space-y-4 lg:space-y-6 pt-12 lg:pt-0">
                  <p className="text-base md:text-lg lg:text-2xl xl:text-3xl text-black mb-2 leading-relaxed">
                    ...
                    for curious teens
                    <br />
                    <span className="text-base lg:text-xl xl:text-2xl">(Ages 14-16)</span>
                  </p>
                ...
                <div className="flex-shrink-0">
                  <img
                    ...
                    alt="Satvik M Patil"
                    className="w-48 md:w-56 lg:w-72 xl:w-80 h-auto object-contain"
                  />
                </div>
              </div>

              {/* Host Information */}
              <div className="bg-white rounded-2xl lg:rounded-3xl border-2 border-gray-200 px-4 lg:px-6 py-3 lg:py-4 mt-6 lg:mt-8 flex justify-between items-center">
                <div className="text-left">
                  <p className="text-xs lg:text-base text-gray-600 mb-1">Your Hosts</p>
                </div>
                <div className="text-right">
                  <p className="text-sm lg:text-lg xl:text-xl font-bold text-black">Satvik M Patil &</p>
                  <p className="text-sm lg:text-lg xl:text-xl font-bold text-black">Mallangouda Patil</p>
                  <p className="text-xs lg:text-base text-gray-700">Mahatayi Gurukul</p>
                </div>
              </div>
            </div>
          </div>
